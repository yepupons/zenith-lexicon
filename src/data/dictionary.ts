...
export const dictionaryData: WordEntry[] = [
  {
    ...
    fullDefinition: "Слово «зерцало» в XVIII веке имело двойное значение. Во-первых, это буквально зеркало. Во-вторых, в переносном смысле — образец, пример, идеал. В названии «Юности честное зерцало» подразумевается второе значение: книга является «зеркалом» правильного поведения для молодых людей.",
  ...
  },
  {
    ...
    fullDefinition: "В XVIII веке «дерзость» имела более сильный негативный оттенок, чем сегодня. Это было нарушение сословной иерархии, вызывающее поведение младшего по отношению к старшему. Дерзость считалась одним из серьёзных недостатков воспитания.",
  ...
  },
  {
    ...
    fullDefinition: "«Обхождение» — ключевой термин этикетных наставлений XVIII века. Обозначает весь комплекс навыков общения: как приветствовать, разговаривать, вести себя за столом. «Житейское обхождение» — это светские манеры, искусство общения.",
    example: "«Юности честное зерцало, или Показание к житейскому обхождению»",
  ...
  },
  {
    ...
    fullDefinition: "«Добродетель» — одно из центральных понятий этической мысли XVIII века. Буквально — «делание добра». Включало честность, милосердие, смирение, трудолюбие, благочестие. Противопоставлялась «пороку» и считалась главной целью воспитания.",
  ...
  },
  {
    ...
    fullDefinition: "«Почтение» в XVIII веке — форма уважения, обязательная для младших по возрасту и положению. Выражалось через поклоны, снятие шляпы, формулы обращения. Отсутствие почтения расценивалось как серьёзное нарушение норм.",
  ...
  },
  {
    ...
    fullDefinition: "«Смирение» — христианская добродетель, высоко ценимая в XVIII веке. Означало не слабость, а сознательный отказ от гордыни, умение принимать замечания старших, скромность в поведении и речах.",
...
export const readingContent: TextFragment[] = [
  {
    id: "fragment-1",
    ...
    parts: [
      ...
      { text: " себя вести, и не с ними Identity вIdentity Identity ряд, Identity Identity Identity Identity Identity Identity Identity Identity Identity Identity Identity Identity Identity Identity Identity Identity Identity